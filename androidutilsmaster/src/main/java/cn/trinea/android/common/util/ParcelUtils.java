...
/**
 * ParcelUtils Android Parcel工具类，可用于从parcel读取或写入特殊类型数据，如： readBoolean(Parcel in)
 * 从pacel中读取boolean类型数据 readHashMap(Parcel in, ClassLoader loader)
 * 从pacel中读取map类型数据 writeBoolean(boolean b, Parcel out) 向parcel中写入boolean类型数据
