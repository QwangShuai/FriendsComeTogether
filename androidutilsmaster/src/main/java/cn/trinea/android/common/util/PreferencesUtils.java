 ...
 * putString(Context, String, String) 保存string类型数据 putInt(Context, String, int)
 * 保存int类型数据 getString(Context, String) 获取string类型数据 getInt(Context, String)
 * 获取int类型数据 可通过修改PREFERENCE_NAME变量修改preference name
