...
public class CreateFriendsTogetherRequestModel {
    ...
    public void setFollow_info(String follow_info) {
    ...
    public String getFollow_pass() {
        return follow_pass;
    }

    public void setFollow_pass(String follow_pass) {
        this.follow_pass = follow_pass;
    }
}
