...
import com.youzhiapp.network.entity.UpdateEntity;
	...
	private Runnable mdownApkRunnable = new Runnable() {	
		...
		public void run() {
			...
			//	String apkName = "OSChinaApp_"+mUpdate.getVersionName()+".apk";
				String apkName = pkg.applicationInfo.loadLabel(context.getPackageManager()).toString();  
			//	String tmpApk = apkName+mUpdate.getVersionName()+".tmp";
				String tmpApk = apkName+BaseApplication.MainJsonObjMap.get(SeverRequire.APP_VERSIONS)+".tmp";
				//判断是否挂载了SD卡
				String storageState = Environment.getExternalStorageState();		
				if(storageState.equals(Environment.MEDIA_MOUNTED)){
					savePath = Environment.getExternalStorageDirectory().getAbsolutePath() + "/"+apkName+"/Update/";
				...
				apkUrl = BaseApplication.MainJsonObjMap.get(SeverRequire.DOWN_URL);
