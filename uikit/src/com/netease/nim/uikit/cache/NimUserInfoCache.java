...
public class NimUserInfoCache {
    ...
    public String getUserName(String account) {
        ...
        if (userInfo != null && !TextUtils.isEmpty(userInfo.getName())) {
            ...
            UserInfoProvider.UserInfo userInfoss = NimUIKit.getUserInfoProvider().getUserInfo(account);
            if (userInfoss != null && !TextUtils.isEmpty(userInfoss.getName())) {
                return userInfoss.getName();
            } else {
                return account;
            }
        }
