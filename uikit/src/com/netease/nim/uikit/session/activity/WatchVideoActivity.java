...
public class WatchVideoActivity extends UI implements Callback {
    ...
    private RelativeLayout window_head_layout;
...
//        setToolBar(R.id.toolbar, options);
    ...
    private void parseIntent() {
        ...
        title.setText(String.format("视频发送于%s", TimeUtil.getDateString(message.getTime())));
    }

    private void findViews() {
        title = findView(R.id.title);
        left = findView(R.id.title_left_image);
        ...
        window_head_layout = (RelativeLayout) findViewById(R.id.title_layout);
    ...
    private void stopMediaPlayer() {
        if (mediaPlayer != null) {
            ...
            mediaPlayer = null;
//            actionBar.show();
            window_head_layout.setVisibility(View.VISIBLE);
        }
    }
...
//                actionBar.hide();
                window_head_layout.setVisibility(View.GONE);
            }
        }
    }
